...
func NewEvent(eventName pkgtypes.EventType, parentId string, parentType EventParentType, parentMetadata json.RawMessage) *Event {
...
func NewEventRepo(db *sqlx.DB) *EventRepo {
	return &EventRepo{
		repo:      db,
		tableName: DBTableName_OutboxEvents,
	}
}
